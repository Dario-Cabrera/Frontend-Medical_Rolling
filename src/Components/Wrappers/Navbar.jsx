  ...
  return (
    <div className="navbar bg-w text-c">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul tabIndex={0} className="bg-w menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow rounded-box w-52">
            ...
            <li>
              <a className="btn btn-xs mt-3 btn-info bg-hb text-w hover:text-c">Admin</a>
            </li>
            <a className="btn btn-xs mt-3 btn-info bg-hb text-w hover:text-c">Registrar</a>
            <a className="btn btn-xs mt-3 btn-info bg-hb text-w hover:text-c">LogIn</a>
          </ul>
        </div>
      ...
      <div className="navbar-end hidden lg:flex">
        ...
        <a className="btn mr-4 btn-info bg-hb text-w hover:text-c">Admin</a>
        <a className="btn mr-4 btn-info bg-hb text-w hover:text-c ">Registrar</a>
        <a className="btn mr-4 btn-info bg-hb text-w hover:text-c">LogIn</a>
      </div>
    </div>
  );
};
