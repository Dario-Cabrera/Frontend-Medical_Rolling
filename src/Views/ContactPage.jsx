...
export const ContactPage = () => {
  ...
  const isSubmit = (data) => {
    ...
    emailjs
      .sendForm("service_nvrhidd", "template_1g2mwhq", form.current, {
    ...
    console.log("Datos enviados:", document.getElementById("user_name").value, document.getElementById("user_lastname").value);
  };
              ...
              <div className="flex place-items-center ">
                <div className="flex align-items-center">
                  <label className="label cursor-pointer">
                    <input type="radio" name="user_plan" value="Joven" className="radio border-c checked:bg-blue-500 mr-1" {...register("user_plan")} />
                    <span className="label-text ml-1 text-c">Plan Jóven</span>
                  </label>
                </div>
                <div className="flex align-items-center">
                  <label className="label cursor-pointer">
                    <input type="radio" name="user_plan" value="Familiar" className="radio border-c checked:bg-green-500 mr-1" {...register("user_plan")} />
                    <span className="label-text ml-1 text-c">Plan Familiar</span>
                  </label>
                </div>
                <div className="flex align-items-center">
                  <label className="label cursor-pointer">
                    <input type="radio" name="user_plan" value="Senior" className="radio border border-c checked:bg-red-500 mr-1" {...register("user_plan")} />
                    <span className="label-text ml-1 text-c">Plan Senior</span>
                  </label>
                </div>
              </div>
              <div className="flex justify-end mt-4">
                <button className="btn btn-info bg-ts hover:bg-hb hover:text-w hover:border-none text-c" type="submit" value="Send">
                  Enviar
                </button>
              </div>
            </form>
